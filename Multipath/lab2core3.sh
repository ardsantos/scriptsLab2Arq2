...
simular()
{
    if [ -d "$GEM5" ]; then
		...
		build/x86_MOESI_CMP_directory/gem5.fast --stats-file=gfSTATS.txt ./configs/example/se.py --cpu-type=DerivO3CPU --bp-type=LTAGE -n 16 --cpu-clock=3GHz --mem-size=1GB --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=256kB --ruby --ruby-clock=3GHz --topology=Multipath --num-dirs=8 --num-l2caches=16 --mesh-rows=4 --network=garnet2.0 --routing-algorithm=0 -c $CAP/gem5/bin/gf -o "--class tiny --nthreads 16" 
